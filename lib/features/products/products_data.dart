...
// ─── Couleurs locales ────────────────────────────────────────────────────────
// (reprises de app_theme.dart pour éviter l'import circulaire)
const _brownMedium = Color(0xFF8A6B4F);
const _brownLight  = Color(0xFFB89A7A);
const _brownDark   = Color(0xFF4A3A2A);
const _nude        = Color(0xFFD9C5B2);
const _cream       = Color(0xFFF4EFEA);

/// Les 9 catégories principales.
...
const List<Product> kMockProducts = [
  Product(
    ...
    heroGradient: [_brownMedium, _brownLight],
  ),
  Product(
    id: '2',
    ...
    heroGradient: [_brownLight, _nude],
  ),
  Product(
    id: '3',
    ...
    heroGradient: [_brownDark, _brownMedium],
  ),
  Product(
    id: '4',
    ...
    heroGradient: [_brownMedium, _cream],
  ),
  Product(
    id: '5',
    ...
    heroGradient: [_brownLight, _brownDark],
  ),
  Product(
    id: '6',
    ...
    heroGradient: [_nude, _brownMedium],
  ),
  Product(
    id: '7',
    ...
    heroGradient: [_cream, _brownLight],
  ),
  Product(
    id: '8',
    ...
    heroGradient: [_brownMedium, _nude],
  ),
  Product(
    id: '9',
    ...
    heroGradient: [_brownLight, _brownMedium],
  ),
  Product(
    id: '10',
    ...
    description:
        ...
        'Esthétique studio et protection numérique toute la journée.',
    priceEur: 340,
    imageAsset: 'assets/products/product_10.png',
    heroGradient: [_nude, _brownDark],
  ),
  Product(
    id: '11',
    ...
    reference: 'ADS-991',
    description:
        'Double pont revisité, or brossé et lignes aérodynamiques. '
        'Prestance masculine sans volume superflu.',
    priceEur: 455,
    imageAsset: 'assets/products/product_11.png',
    heroGradient: [_brownMedium, _brownDark],
  ),
  Product(
    id: '12',
    ...
    heroGradient: [_brownDark, _brownLight],
  ),
  Product(
    id: '13',
  ...
  Product(
    ...
    heroGradient: [_cream, _brownMedium],
  ),
];
